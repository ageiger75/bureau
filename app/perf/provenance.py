...
REGISTER: Dict[str, Measure] = {
    ...
    "third_party_stores": Measure(
        ...
        "column in it that is neither a budget nor an estimate — the closed year. "
        "Department stores did 7 860k€ in FY25, so 1 965k€ a quarter; the channel grows "
        "about 6% a year on the deck's own series, which puts a FY27 quarter near "
        "2 210k€. The warehouse drops 2 318k€. Five per cent apart, against a year that "
        "is finished.\n\n"
        "Deliberately not against the deck's 9 226k€ for the year in progress: that is a "
